...
// Auto-generated by 'pnpm server:modules'

lazy val allModules = Seq(commonM, dbM, memoM, hubM, i18nM, socketM, ratingM, userM, oauthM, securityM, chatM, prefM, gameM, relationM, notifyM, shutupM, treeM, historyM, msgM, evalCacheM, analyseM, puzzleM, roomM, playbanM, shoginetM, roundM, reportM, simulM, perfStatM, evaluationM, tournamentM, modM, importerM, forumM, searchM, studyM, teamM, challengeM, lobbyM, forumSearchM, streamerM, timelineM, botM, coachM, bookmarkM, studySearchM, planM, teamSearchM, tvM, chatroomM, activityM, appealM, articleM, stormM, clasM, coordinateM, gameSearchM, pushM, apiM, setupM, eventM, learnM)
...
lazy val roundM = module("round", Seq(playbanM, roomM, shoginetM))
...
lazy val bookmarkM = module("bookmark", Seq(roundM))
...
lazy val activityM = module("activity", Seq(forumM, studyM, teamM))
...
lazy val chatroomM = module("chatroom", Seq(roomM))
...
lazy val challengeM = module("challenge", Seq(tournamentM))
