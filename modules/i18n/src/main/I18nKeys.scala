...
object I18nKeys {
  ...
  val `playOtherPlayers` = new I18nKey("playOtherPlayers")
  ...
  val `defeatedAiNameAiLevel` = new I18nKey("defeatedAiNameAiLevel")
  val `level` = new I18nKey("level")
  val `levelX` = new I18nKey("levelX")
  ...
  val `page` = new I18nKey("page")
  val `resign` = new I18nKey("resign")
  val `checkmate` = new I18nKey("checkmate")
  val `stalemate` = new I18nKey("stalemate")
  val `resignation` = new I18nKey("resignation")
  val `check` = new I18nKey("check")
  val `impasse` = new I18nKey("impasse")
  val `repetition` = new I18nKey("repetition")
  ...
  val `xWon` = new I18nKey("xWon")
  val `xLost` = new I18nKey("xLost")
  val `gameWasDraw` = new I18nKey("gameWasDraw")
  val `winnerIsNotYetDecided` = new I18nKey("winnerIsNotYetDecided")
  val `gote` = new I18nKey("gote")
  val `white` = new I18nKey("white")
  val `sente` = new I18nKey("sente")
  val `black` = new I18nKey("black")
  val `shitate` = new I18nKey("shitate")
  val `uwate` = new I18nKey("uwate")
  val `randomColor` = new I18nKey("randomColor")
  val `createAGame` = new I18nKey("createAGame")
  val `xIsVictorious` = new I18nKey("xIsVictorious")
  val `youPlayAsX` = new I18nKey("youPlayAsX")
  ...
  val `registeredJoinTheGame` = new I18nKey("registeredJoinTheGame")
  val `outsideYourRating` = new I18nKey("outsideYourRating")
  val `gamesOutsideYourRatingRange` = new I18nKey("gamesOutsideYourRatingRange")
  val `xPlays` = new I18nKey("xPlays")
  ...
  val `playersCannotSeeMessagesDuringGame` = new I18nKey("playersCannotSeeMessagesDuringGame")
  val `theFirstPersonToComeOnThisUrlWillPlayWithYou` = new I18nKey("theFirstPersonToComeOnThisUrlWillPlayWithYou")
  val `xResigned` = new I18nKey("xResigned")
  val `xLeftTheGame` = new I18nKey("xLeftTheGame")
  val `xDidntMove` = new I18nKey("xDidntMove")
  val `xPlayedIllegalMove` = new I18nKey("xPlayedIllegalMove")
  ...
  val `analysisDescription` = new I18nKey("analysisDescription")
  val `depthX` = new I18nKey("depthX")
  val `serverAnalysis` = new I18nKey("serverAnalysis")
  ...
  val `localAnalysis` = new I18nKey("localAnalysis")
  ...
  val `pageNotFound` = new I18nKey("pageNotFound")
  val `returnToHomepage` = new I18nKey("returnToHomepage")
  ...
  val `kif` = new I18nKey("kif")
  val `csa` = new I18nKey("csa")
  val `importKif` = new I18nKey("importKif")
  val `importCsa` = new I18nKey("importCsa")
  ...
  val `offerAdjournment` = new I18nKey("offerAdjournment")
  val `offerResumption` = new I18nKey("offerResumption")
  val `acceptResumption` = new I18nKey("acceptResumption")
  val `draw` = new I18nKey("draw")
  val `gameAdjourned` = new I18nKey("gameAdjourned")
  val `gameResumed` = new I18nKey("gameResumed")
  ...
  val `forumDescription` = new I18nKey("forumDescription")
  ...
  val `loginByEmail` = new I18nKey("loginByEmail")
  ...
  val `confirm` = new I18nKey("confirm")
  val `cancel` = new I18nKey("cancel")
  val `start` = new I18nKey("start")
  ...
  val `adjournmentOfferSent` = new I18nKey("adjournmentOfferSent")
  val `adjournmentOfferCanceled` = new I18nKey("adjournmentOfferCanceled")
  val `adjournmentOfferAccepted` = new I18nKey("adjournmentOfferAccepted")
  val `resumptionOfferSent` = new I18nKey("resumptionOfferSent")
  val `resumptionOfferCanceled` = new I18nKey("resumptionOfferCanceled")
  val `xOffersDraw` = new I18nKey("xOffersDraw")
  val `xDeclinesDraw` = new I18nKey("xDeclinesDraw")
  val `yourOpponentOffersADraw` = new I18nKey("yourOpponentOffersADraw")
  val `xOffersAdjournment` = new I18nKey("xOffersAdjournment")
  val `xDeclinesAdjournment` = new I18nKey("xDeclinesAdjournment")
  val `yourOpponentOffersAnAdjournment` = new I18nKey("yourOpponentOffersAnAdjournment")
  val `xOffersResumption` = new I18nKey("xOffersResumption")
  val `xDeclinesResumption` = new I18nKey("xDeclinesResumption")
  val `yourOpponentProposesResumption` = new I18nKey("yourOpponentProposesResumption")
  val `makeASealedMove` = new I18nKey("makeASealedMove")
  val `waitingForASealedMove` = new I18nKey("waitingForASealedMove")
  ...
  val `rules` = new I18nKey("rules")
  val `standard` = new I18nKey("standard")
  val `minishogi` = new I18nKey("minishogi")
  val `chushogi` = new I18nKey("chushogi")
  ...
  val `rematchOfferSentX` = new I18nKey("rematchOfferSentX")
  ...
  val `byoyomiInSeconds` = new I18nKey("byoyomiInSeconds")
  val `numberOfPeriods` = new I18nKey("numberOfPeriods")
  val `freeOnlineShogi` = new I18nKey("freeOnlineShogi")
  val `spectators` = new I18nKey("spectators")
  val `exportGames` = new I18nKey("exportGames")
  val `export` = new I18nKey("export")
  ...
  val `tournamentLeaderboard` = new I18nKey("tournamentLeaderboard")
  val `tournaments` = new I18nKey("tournaments")
  val `myTournaments` = new I18nKey("myTournaments")
  ...
  val `leaderboards` = new I18nKey("leaderboards")
  val `bestPlayersInVariousCategories` = new I18nKey("bestPlayersInVariousCategories")
  val `topXPlayersInY` = new I18nKey("topXPlayersInY")
  val `selectHandicap` = new I18nKey("selectHandicap")
  val `pasteTheSfenStringHere` = new I18nKey("pasteTheSfenStringHere")
  val `pasteTheKifCsaStringHere` = new I18nKey("pasteTheKifCsaStringHere")
  val `fromPosition` = new I18nKey("fromPosition")
  val `default` = new I18nKey("default")
  val `continueFromHere` = new I18nKey("continueFromHere")
  val `toStudy` = new I18nKey("toStudy")
  val `importGame` = new I18nKey("importGame")
  val `importCategory` = new I18nKey("importCategory")
  val `importedGame` = new I18nKey("importedGame")
  val `importedByX` = new I18nKey("importedByX")
  val `importGameKifCsaExplanation` = new I18nKey("importGameKifCsaExplanation")
  val `thisIsAShogiCaptcha` = new I18nKey("thisIsAShogiCaptcha")
  ...
  val `xCheckmatesInOneMove` = new I18nKey("xCheckmatesInOneMove")
  ...
  val `followers` = new I18nKey("followers")
  ...
  val `viewChallenge` = new I18nKey("viewChallenge")
  val `noChallenges` = new I18nKey("noChallenges")
  ...
  val `emptyTournamentAnimalName` = new I18nKey("emptyTournamentAnimalName")
  ...
  val `askToJoin` = new I18nKey("askToJoin")
  val `waitingForApproval` = new I18nKey("waitingForApproval")
  val `pause` = new I18nKey("pause")
  val `denied` = new I18nKey("denied")
  ...
  val `waitingForPlayersToPair` = new I18nKey("waitingForPlayersToPair")
  ...
  val `thisIsProfilePage` = new I18nKey("thisIsProfilePage")
  ...
  val `watchLishogiTV` = new I18nKey("watchLishogiTV")
  val `watchLishogiTVDescription` = new I18nKey("watchLishogiTVDescription")
  val `previouslyOnLishogiTV` = new I18nKey("previouslyOnLishogiTV")
  val `onlinePlayers` = new I18nKey("onlinePlayers")
  val `onlineBots` = new I18nKey("onlineBots")
  ...
  val `brilliantMove` = new I18nKey("brilliantMove")
  val `bestMove` = new I18nKey("bestMove")
  val `success` = new I18nKey("success")
  val `thankYou` = new I18nKey("thankYou")
  val `ratingX` = new I18nKey("ratingX")
  val `hidden` = new I18nKey("hidden")
  val `fromGameLink` = new I18nKey("fromGameLink")
  ...
  val `yourTeamBoards` = new I18nKey("yourTeamBoards")
  ...
  val `writeAPrivateNoteAboutThisUser` = new I18nKey("writeAPrivateNoteAboutThisUser")
  val `noNoteYet` = new I18nKey("noNoteYet")
  ...
  val `clockByoyomi` = new I18nKey("clockByoyomi")
  ...
  val `youWon` = new I18nKey("youWon")
  val `defeat` = new I18nKey("defeat")
  val `youLost` = new I18nKey("youLost")
  val `xVsY` = new I18nKey("xVsY")
  ...
  val `connectedToLishogi` = new I18nKey("connectedToLishogi")
  ...
  val `byoyomi` = new I18nKey("byoyomi")
  val `periods` = new I18nKey("periods")
  ...
  val `xIsAFreeYLibreOpenSourceShogiServer` = new I18nKey("xIsAFreeYLibreOpenSourceShogiServer")
  ...
  val `xSimul` = new I18nKey("xSimul")
  val `simulComplete` = new I18nKey("simulComplete")
  val `backToSimul` = new I18nKey("backToSimul")
  ...
  val `yourPendingSimuls` = new I18nKey("yourPendingSimuls")
  ...
  val `numberOfByoyomiPeriods` = new I18nKey("numberOfByoyomiPeriods")
  val `hostColorForEachGame` = new I18nKey("hostColorForEachGame")
  ...
  val `anythingTellParticipants` = new I18nKey("anythingTellParticipants")
  val `lishogiTournaments` = new I18nKey("lishogiTournaments")
  val `tournamentShields` = new I18nKey("tournamentShields")
  ...
  val `monthlyPerfTypeRatingDistribution` = new I18nKey("monthlyPerfTypeRatingDistribution")
  ...
  val `networkLagBetweenYouAndLishogi` = new I18nKey("networkLagBetweenYouAndLishogi")
  val `timeToProcessAMoveOnLishogiServer` = new I18nKey("timeToProcessAMoveOnLishogiServer")
  ...
  val `inKidModeTheLishogiLogoGetsIconX` = new I18nKey("inKidModeTheLishogiLogoGetsIconX")
  ...
  val `playShogiEverywhere` = new I18nKey("playShogiEverywhere")
  val `features` = new I18nKey("features")
  val `asFreeAsLishogi` = new I18nKey("asFreeAsLishogi")
  val `builtForTheLoveOfShogiNotMoney` = new I18nKey("builtForTheLoveOfShogiNotMoney")
  ...
  val `correspondenceShogi` = new I18nKey("correspondenceShogi")
  ...
  val `presets` = new I18nKey("presets")
  val `anonymous` = new I18nKey("anonymous")
  val `anonymousUser` = new I18nKey("anonymousUser")
  ...
  val `backgroundColor` = new I18nKey("backgroundColor")
  val `gridColor` = new I18nKey("gridColor")
  val `gridWidth` = new I18nKey("gridWidth")
  val `board` = new I18nKey("board")
  val `grid` = new I18nKey("grid")
  val `gridSlim` = new I18nKey("gridSlim")
  val `gridThick` = new I18nKey("gridThick")
  val `gridVeryThick` = new I18nKey("gridVeryThick")
  val `hands` = new I18nKey("hands")
  ...
  val `directlySupportLishogi` = new I18nKey("directlySupportLishogi")
  val `playShogiInStyle` = new I18nKey("playShogiInStyle")
  val `shogiBasics` = new I18nKey("shogiBasics")
  val `shogiResources` = new I18nKey("shogiResources")
  val `coaches` = new I18nKey("coaches")
  val `invalidNotation` = new I18nKey("invalidNotation")
  val `invalidSfen` = new I18nKey("invalidSfen")
  ...
  val `xWinsGame` = new I18nKey("xWinsGame")
  ...
  val `prev` = new I18nKey("prev")
  val `xWasPlayed` = new I18nKey("xWasPlayed")
  val `findBetterMoveForX` = new I18nKey("findBetterMoveForX")
  val `resumeLearning` = new I18nKey("resumeLearning")
  val `youCanDoBetter` = new I18nKey("youCanDoBetter")
  val `tryAnotherMoveForX` = new I18nKey("tryAnotherMoveForX")
  val `solution` = new I18nKey("solution")
  val `waitingForAnalysis` = new I18nKey("waitingForAnalysis")
  val `noMistakesFoundForX` = new I18nKey("noMistakesFoundForX")
  val `doneReviewingXMistakes` = new I18nKey("doneReviewingXMistakes")
  val `doItAgain` = new I18nKey("doItAgain")
  val `reviewXMistakes` = new I18nKey("reviewXMistakes")
  ...
  val `pleasantShogiExperience` = new I18nKey("pleasantShogiExperience")
  ...
  val `agreeWithX` = new I18nKey("agreeWithX")
  val `searchOrStartNewDiscussion` = new I18nKey("searchOrStartNewDiscussion")
  val `edit` = new I18nKey("edit")
  val `ultrabullet` = new I18nKey("ultrabullet")
  val `bullet` = new I18nKey("bullet")
  val `blitz` = new I18nKey("blitz")
  val `veryFastShogi` = new I18nKey("veryFastShogi")
  val `fastShogi` = new I18nKey("fastShogi")
  ...
  val `notationSystem` = new I18nKey("notationSystem")
  val `invadingPieces` = new I18nKey("invadingPieces")
  val `enteringKing` = new I18nKey("enteringKing")
  val `totalImpasseValue` = new I18nKey("totalImpasseValue")
  val `postGameStudy` = new I18nKey("postGameStudy")
  val `postGameStudies` = new I18nKey("postGameStudies")
  val `postGameStudyExplanation` = new I18nKey("postGameStudyExplanation")
  val `postGameStudiesOfGame` = new I18nKey("postGameStudiesOfGame")
  val `studyWithOpponent` = new I18nKey("studyWithOpponent")
  val `studyOfPlayers` = new I18nKey("studyOfPlayers")
  val `studyWith` = new I18nKey("studyWith")
  val `optional` = new I18nKey("optional")
  val `standardStudy` = new I18nKey("standardStudy")
  val `welcomeToX` = new I18nKey("welcomeToX")
  val `whatNow` = new I18nKey("whatNow")
  val `hereAreSuggestions` = new I18nKey("hereAreSuggestions")
  val `hangOn` = new I18nKey("hangOn")
  val `gameInProgressWithX` = new I18nKey("gameInProgressWithX")
  val `or` = new I18nKey("or")
  val `gameInProgressDescription` = new I18nKey("gameInProgressDescription")
  ...
  val `challengeCorrespondenceDescription` = new I18nKey("challengeCorrespondenceDescription")
  val `openChallenge` = new I18nKey("openChallenge")
  val `challengeDescription` = new I18nKey("challengeDescription")
  val `challengeFromX` = new I18nKey("challengeFromX")
  val `xChallengesY` = new I18nKey("xChallengesY")
  val `pressXtoFocus` = new I18nKey("pressXtoFocus")
  val `pressXtoSubmit` = new I18nKey("pressXtoSubmit")
  val `clickGame` = new I18nKey("clickGame")
  ...
  val `generalShogiDiscussionForum` = new I18nKey("generalShogiDiscussionForum")
  val `gameAnalysisForum` = new I18nKey("gameAnalysisForum")
  val `lishogiFeedbackForum` = new I18nKey("lishogiFeedbackForum")
  val `offTopicDiscussionForum` = new I18nKey("offTopicDiscussionForum")
  val `teamXForum` = new I18nKey("teamXForum")
  val `kickPlayer` = new I18nKey("kickPlayer")
  val `managePlayers` = new I18nKey("managePlayers")
  val `notReversible` = new I18nKey("notReversible")
  val `shareMainlineUrl` = new I18nKey("shareMainlineUrl")
  val `tourCreated` = new I18nKey("tourCreated")
  val `tourRecent` = new I18nKey("tourRecent")
  val `tourFormat` = new I18nKey("tourFormat")
  val `tourUpcoming` = new I18nKey("tourUpcoming")
  val `bestResults` = new I18nKey("bestResults")
  val `stats` = new I18nKey("stats")
  ...
  val `acceptPlayersStartSimul` = new I18nKey("acceptPlayersStartSimul")
  ...
  val `xJoinedTheGame` = new I18nKey("xJoinedTheGame")
  val `connectingToTheGame` = new I18nKey("connectingToTheGame")
  val `bestMoveWasX` = new I18nKey("bestMoveWasX")
  val `mateCreatedDescription` = new I18nKey("mateCreatedDescription")
  val `mateDelayedDescription` = new I18nKey("mateDelayedDescription")
  val `mateLostDescription` = new I18nKey("mateLostDescription")
  val `dotSymbol` = new I18nKey("dotSymbol")
  val `colonSymbol` = new I18nKey("colonSymbol")
  ...
  val `ranks` = new I18nKey("ranks")
  val `youRankedUp` = new I18nKey("youRankedUp")
  val `ranksAfterStable` = new I18nKey("ranksAfterStable")
  val `leavingLobbyAlert` = new I18nKey("leavingLobbyAlert")
  val `oneUrlPerLine` = new I18nKey("oneUrlPerLine")
  val `translate` = new I18nKey("translate")
  val `newPlayerIntro` = new I18nKey("newPlayerIntro")
  val `newPlayerRegisterCta` = new I18nKey("newPlayerRegisterCta")
  val `newPlayerPreferences` = new I18nKey("newPlayerPreferences")
  val `newPlayerLearn` = new I18nKey("newPlayerLearn")
  val `newPlayerPlayPeople` = new I18nKey("newPlayerPlayPeople")
  val `newPlayerPlayAi` = new I18nKey("newPlayerPlayAi")
  val `newPlayerTournaments` = new I18nKey("newPlayerTournaments")
  val `newPlayerPuzzles` = new I18nKey("newPlayerPuzzles")
  val `newPlayerStudies` = new I18nKey("newPlayerStudies")
  val `allLanguages` = new I18nKey("allLanguages")
  val `begForDonations` = new I18nKey("begForDonations")
  val `chooseFileOrDrag` = new I18nKey("chooseFileOrDrag")
  val `profilePicture` = new I18nKey("profilePicture")
  val `documentation` = new I18nKey("documentation")
  ...
  val `nbAdjourned` = new I18nKey("nbAdjourned")
  ...
  val `playedXTimes` = new I18nKey("playedXTimes")
  ...
  val `nbPerfTypePlayersThisMonth` = new I18nKey("nbPerfTypePlayersThisMonth")
  ...
  val `nbMinutes` = new I18nKey("nbMinutes")
  ...
  object arena {
    val `arena` = new I18nKey("arena:arena")
    ...
    val `noBerserkAllowed` = new I18nKey("arena:noBerserkAllowed")
    ...
    val `defender` = new I18nKey("arena:defender")
    val `drawingWithinNbMoves` = new I18nKey("arena:drawingWithinNbMoves")
    val `viewAllXTeams` = new I18nKey("arena:viewAllXTeams")
}

  object article {
    val `articles` = new I18nKey("article:articles")
    val `recentArticles` = new I18nKey("article:recentArticles")
    val `bestArticles` = new I18nKey("article:bestArticles")
    val `likedArticles` = new I18nKey("article:likedArticles")
    val `myArticles` = new I18nKey("article:myArticles")
    val `articlesWrittenByX` = new I18nKey("article:articlesWrittenByX")
    val `submittedArticles` = new I18nKey("article:submittedArticles")
    val `categories` = new I18nKey("article:categories")
    val `draft` = new I18nKey("article:draft")
    val `published` = new I18nKey("article:published")
    val `drafts` = new I18nKey("article:drafts")
    val `author` = new I18nKey("article:author")
    val `translateArticle` = new I18nKey("article:translateArticle")
    val `translator` = new I18nKey("article:translator")
    val `noneYet` = new I18nKey("article:noneYet")
    val `newArticle` = new I18nKey("article:newArticle")
    val `newArticleByX` = new I18nKey("article:newArticleByX")
    val `editArticle` = new I18nKey("article:editArticle")
    val `deleteArticle` = new I18nKey("article:deleteArticle")
    val `deleteXLangOfArticle` = new I18nKey("article:deleteXLangOfArticle")
    val `categoryAll` = new I18nKey("article:categoryAll")
    val `categoryOfficial` = new I18nKey("article:categoryOfficial")
    val `categoryAnalysis` = new I18nKey("article:categoryAnalysis")
    val `categoryCulture` = new I18nKey("article:categoryCulture")
    val `categoryEvents` = new I18nKey("article:categoryEvents")
    val `categoryGuides` = new I18nKey("article:categoryGuides")
    val `categoryLishogi` = new I18nKey("article:categoryLishogi")
    val `categorySoftware` = new I18nKey("article:categorySoftware")
    val `categoryVariants` = new I18nKey("article:categoryVariants")
    val `title` = new I18nKey("article:title")
    val `coverImage` = new I18nKey("article:coverImage")
    val `introText` = new I18nKey("article:introText")
    val `introHelp` = new I18nKey("article:introHelp")
    val `bodyText` = new I18nKey("article:bodyText")
    val `submitForPublishing` = new I18nKey("article:submitForPublishing")
    val `saveAsDraft` = new I18nKey("article:saveAsDraft")
    val `discuss` = new I18nKey("article:discuss")
    val `articleIsADraft` = new I18nKey("article:articleIsADraft")
    val `articleUnderReview` = new I18nKey("article:articleUnderReview")
    val `shortTOS` = new I18nKey("article:shortTOS")
    val `articlePublished` = new I18nKey("article:articlePublished")
    val `Read the article here` = new I18nKey("article:Read the article here")
}
  ...
  object clas {
    val `lishogiClasses` = new I18nKey("class:lishogiClasses")
    val `teachClassesOfShogiStudents` = new I18nKey("class:teachClassesOfShogiStudents")
    ...
    val `applyToBeLishogiTeacher` = new I18nKey("class:applyToBeLishogiTeacher")
    ...
    val `addLishogiUsernames` = new I18nKey("class:addLishogiUsernames")
    ...
    val `lishogiProfileXCreatedForY` = new I18nKey("class:lishogiProfileXCreatedForY")
    val `studentCredentials` = new I18nKey("class:studentCredentials")
    val `inviteALishogiAccount` = new I18nKey("class:inviteALishogiAccount")
    ...
    val `createANewLishogiAccount` = new I18nKey("class:createANewLishogiAccount")
    ...
    val `lishogiUsername` = new I18nKey("class:lishogiUsername")
  ...
  object coach {
    val `lishogiCoach` = new I18nKey("coach:lishogiCoach")
    val `editMyCoachProfile` = new I18nKey("coach:editMyCoachProfile")
    val `lishogiOnlyFeatures` = new I18nKey("coach:lishogiOnlyFeatures")
    val `lishogiNoFees` = new I18nKey("coach:lishogiNoFees")
    val `becomeACoach` = new I18nKey("coach:becomeACoach")
    ...
    val `headline` = new I18nKey("coach:headline")
    val `publishOnList` = new I18nKey("coach:publishOnList")
    val `publishOnListHelp` = new I18nKey("coach:publishOnListHelp")
    val `availableForLessons` = new I18nKey("coach:availableForLessons")
    val `availableForLessonsHelp` = new I18nKey("coach:availableForLessonsHelp")
    val `languagesSpoken` = new I18nKey("coach:languagesSpoken")
    val `languagesSpokenHelp` = new I18nKey("coach:languagesSpokenHelp")
    val `hourlyRateHelp` = new I18nKey("coach:hourlyRateHelp")
    val `whoAreYou` = new I18nKey("coach:whoAreYou")
    val `whoAreYouHelp` = new I18nKey("coach:whoAreYouHelp")
    val `playingExperienceHelp` = new I18nKey("coach:playingExperienceHelp")
    val `teachingExperienceHelp` = new I18nKey("coach:teachingExperienceHelp")
    val `otherExperiencesHelp` = new I18nKey("coach:otherExperiencesHelp")
    val `bestSkillsHelp` = new I18nKey("coach:bestSkillsHelp")
    val `teachingMethodHelp` = new I18nKey("coach:teachingMethodHelp")
    val `publicStudiesHelp` = new I18nKey("coach:publicStudiesHelp")
    val `youtubeChannelUrl` = new I18nKey("coach:youtubeChannelUrl")
    val `youtubeVideosHelp` = new I18nKey("coach:youtubeVideosHelp")
}

  object contact {
    val `contact` = new I18nKey("contact:contact")
    val `contactLishogi` = new I18nKey("contact:contactLishogi")
    ...
    val `buyingLishogi` = new I18nKey("contact:buyingLishogi")
  ...
  object coordinates {
    ...
    val `averageScoreAsXY` = new I18nKey("coordinates:averageScoreAsXY")
    val `knowingTheShogiBoard` = new I18nKey("coordinates:knowingTheShogiBoard")
    val `mostShogiCourses` = new I18nKey("coordinates:mostShogiCourses")
    val `talkToYourShogiFriends` = new I18nKey("coordinates:talkToYourShogiFriends")
  ...
  object emails {
    ...
    val `logInToLishogi` = new I18nKey("emails:logInToLishogi")
  ...
  object faq {
    ...
    val `otherWaysToContribute` = new I18nKey("faq:otherWaysToContribute")
    ...
    val `formulaOfDuration` = new I18nKey("faq:formulaOfDuration")
    ...
    val `lishogiSupportShogiAnd` = new I18nKey("faq:lishogiSupportShogiAnd")
    ...
    val `lishogiTraining` = new I18nKey("faq:lishogiTraining")
    val `fourfoldRepetition` = new I18nKey("faq:fourfoldRepetition")
    ...
    val `titlesAvailableOnLishogi` = new I18nKey("faq:titlesAvailableOnLishogi")
    ...
    val `lishogiRatings` = new I18nKey("faq:lishogiRatings")
    val `whichRatingSystemUsedByLishogi` = new I18nKey("faq:whichRatingSystemUsedByLishogi")
    val `ratingSystemUsedByLishogi` = new I18nKey("faq:ratingSystemUsedByLishogi")
    val `ratingSystemUsedByLishogiDraw` = new I18nKey("faq:ratingSystemUsedByLishogiDraw")
    ...
    val `havePlayedARatedGameAtLeastOneMonthAgo` = new I18nKey("faq:havePlayedARatedGameAtLeastOneMonthAgo")
    val `ratingDeviationLowerThanXinShogiYinVariants` = new I18nKey("faq:ratingDeviationLowerThanXinShogiYinVariants")
    val `beInTopTen` = new I18nKey("faq:beInTopTen")
    val `clickHereRatingRanks` = new I18nKey("faq:clickHereRatingRanks")
    ...
    val `lishogiCanOptionnalySendPopUps` = new I18nKey("faq:lishogiCanOptionnalySendPopUps")
}

  object insights {
    val `insights` = new I18nKey("insights:insights")
    val `moves` = new I18nKey("insights:moves")
    val `drops` = new I18nKey("insights:drops")
    val `movesAndDrops` = new I18nKey("insights:movesAndDrops")
    val `total` = new I18nKey("insights:total")
    val `count` = new I18nKey("insights:count")
    val `average` = new I18nKey("insights:average")
    val `percentage` = new I18nKey("insights:percentage")
    val `outcomes` = new I18nKey("insights:outcomes")
    val `color` = new I18nKey("insights:color")
    val `termination` = new I18nKey("insights:termination")
    val `resign` = new I18nKey("insights:resign")
    val `noStart` = new I18nKey("insights:noStart")
    val `speed` = new I18nKey("insights:speed")
    val `game` = new I18nKey("insights:game")
    val `opponents` = new I18nKey("insights:opponents")
    val `averageOpponentRating` = new I18nKey("insights:averageOpponentRating")
    val `averageOpponentRatingDiff` = new I18nKey("insights:averageOpponentRatingDiff")
    val `mostPlayedOpponents` = new I18nKey("insights:mostPlayedOpponents")
    val `averageAccuracy` = new I18nKey("insights:averageAccuracy")
    val `wins` = new I18nKey("insights:wins")
    val `draws` = new I18nKey("insights:draws")
    val `losses` = new I18nKey("insights:losses")
    val `accuracyByMoveNumber` = new I18nKey("insights:accuracyByMoveNumber")
    val `accuracyByPiece` = new I18nKey("insights:accuracyByPiece")
    val `times` = new I18nKey("insights:times")
    val `totalTimeSpentThinking` = new I18nKey("insights:totalTimeSpentThinking")
    val `averageTimePerGame` = new I18nKey("insights:averageTimePerGame")
    val `averageTimePerMoveOrDrop` = new I18nKey("insights:averageTimePerMoveOrDrop")
    val `timeSpentThinkingByPiece` = new I18nKey("insights:timeSpentThinkingByPiece")
    val `movesAndDropsByPiece` = new I18nKey("insights:movesAndDropsByPiece")
    val `capturesByPiece` = new I18nKey("insights:capturesByPiece")
    val `promotionsByPiece` = new I18nKey("insights:promotionsByPiece")
    val `mostPlayedOpenings` = new I18nKey("insights:mostPlayedOpenings")
    val `openingMoves` = new I18nKey("insights:openingMoves")
    val `insightsUpdate` = new I18nKey("insights:insightsUpdate")
    val `accuracy` = new I18nKey("insights:accuracy")
    val `nbOfMovesAndDrops` = new I18nKey("insights:nbOfMovesAndDrops")
    val `nbOfMovesAndDropsPerGame` = new I18nKey("insights:nbOfMovesAndDropsPerGame")
    val `nbOfCaptures` = new I18nKey("insights:nbOfCaptures")
    val `nbOfPromotions` = new I18nKey("insights:nbOfPromotions")
    val `opponentRating` = new I18nKey("insights:opponentRating")
    val `opponentRatingDiff` = new I18nKey("insights:opponentRatingDiff")
    val `totalTimeOfMovesAndDrops` = new I18nKey("insights:totalTimeOfMovesAndDrops")
    val `nbOfGames` = new I18nKey("insights:nbOfGames")
    val `weekday` = new I18nKey("insights:weekday")
    val `timeOfDay` = new I18nKey("insights:timeOfDay")
    val `earlyBishopExchange` = new I18nKey("insights:earlyBishopExchange")
}

  object lag {
    val `isLishogiLagging` = new I18nKey("lag:isLishogiLagging")
    ...
    val `lishogiServerLatency` = new I18nKey("lag:lishogiServerLatency")
    val `lishogiServerLatencyExplanation` = new I18nKey("lag:lishogiServerLatencyExplanation")
    val `networkBetweenLishogiAndYou` = new I18nKey("lag:networkBetweenLishogiAndYou")
    val `networkBetweenLishogiAndYouExplanation` = new I18nKey("lag:networkBetweenLishogiAndYouExplanation")
  ...
  object learn {
    val `learnShogi` = new I18nKey("learn:learnShogi")
    ...
    val `clickHereAfterYouveChosen` = new I18nKey("learn:clickHereAfterYouveChosen")
    val `tellYourPiecesApart` = new I18nKey("learn:tellYourPiecesApart")
    val `howToSelectPieceSet` = new I18nKey("learn:howToSelectPieceSet")
    val `choosePieceDesign` = new I18nKey("learn:choosePieceDesign")
    val `choosePieceDesignShort` = new I18nKey("learn:choosePieceDesignShort")
    val `promotionZone` = new I18nKey("learn:promotionZone")
    val `senteGoesFirst` = new I18nKey("learn:senteGoesFirst")
    val `introComplete` = new I18nKey("learn:introComplete")
    val `introCompleteTwo` = new I18nKey("learn:introCompleteTwo")
    ...
    val `grabAllTheStarsRemember` = new I18nKey("learn:grabAllTheStarsRemember")
    val `rookPromotion` = new I18nKey("learn:rookPromotion")
    val `rookSummary` = new I18nKey("learn:rookSummary")
    val `dragonSummary` = new I18nKey("learn:dragonSummary")
    val `dragonSummaryTwo` = new I18nKey("learn:dragonSummaryTwo")
    ...
    val `ehThereIsNoPiece` = new I18nKey("learn:ehThereIsNoPiece")
    val `bishopPromotion` = new I18nKey("learn:bishopPromotion")
    val `bishopSummary` = new I18nKey("learn:bishopSummary")
    val `horseSummary` = new I18nKey("learn:horseSummary")
    ...
    val `kingSummary` = new I18nKey("learn:kingSummary")
    ...
    val `knightSummary` = new I18nKey("learn:knightSummary")
    val `pknightSummary` = new I18nKey("learn:pknightSummary")
    val `knightPromotion` = new I18nKey("learn:knightPromotion")
    ...
    val `pawnSummary` = new I18nKey("learn:pawnSummary")
    val `tokinSummary` = new I18nKey("learn:tokinSummary")
    val `theLance` = new I18nKey("learn:theLance")
    val `itMovesStraightForward` = new I18nKey("learn:itMovesStraightForward")
    val `lanceIntro` = new I18nKey("learn:lanceIntro")
    val `lancesAreStraighforward` = new I18nKey("learn:lancesAreStraighforward")
    val `lancePromotion` = new I18nKey("learn:lancePromotion")
    val `lanceSummary` = new I18nKey("learn:lanceSummary")
    val `planceSummary` = new I18nKey("learn:planceSummary")
    val `planceSummaryTwo` = new I18nKey("learn:planceSummaryTwo")
    val `lanceComplete` = new I18nKey("learn:lanceComplete")
    val `theGold` = new I18nKey("learn:theGold")
    val `itMovesInAnyDirectionExceptDiagonallyBack` = new I18nKey("learn:itMovesInAnyDirectionExceptDiagonallyBack")
    val `goldIntro` = new I18nKey("learn:goldIntro")
    val `goldDoesntPromote` = new I18nKey("learn:goldDoesntPromote")
    val `goldSummary` = new I18nKey("learn:goldSummary")
    val `goldComplete` = new I18nKey("learn:goldComplete")
    val `theSilver` = new I18nKey("learn:theSilver")
    val `itMovesEitherForwardOrDiagonallyBack` = new I18nKey("learn:itMovesEitherForwardOrDiagonallyBack")
    val `silverIntro` = new I18nKey("learn:silverIntro")
    val `silverPromotion` = new I18nKey("learn:silverPromotion")
    val `silverSummary` = new I18nKey("learn:silverSummary")
    val `psilverSummary` = new I18nKey("learn:psilverSummary")
    val `silverComplete` = new I18nKey("learn:silverComplete")
    val `promotion` = new I18nKey("learn:promotion")
    val `yourPieceReachedThePromotionZone` = new I18nKey("learn:yourPieceReachedThePromotionZone")
    ...
    val `takeTheEnemyPiecesAndDontLoseYours` = new I18nKey("learn:takeTheEnemyPiecesAndDontLoseYours")
    val `captureComplete` = new I18nKey("learn:captureComplete")
    val `pieceDrops` = new I18nKey("learn:pieceDrops")
    val `reuseCapturedPieces` = new I18nKey("learn:reuseCapturedPieces")
    val `dropIntro` = new I18nKey("learn:dropIntro")
    val `capturedPiecesCanBeDropped` = new I18nKey("learn:capturedPiecesCanBeDropped")
    val `dropLimitations` = new I18nKey("learn:dropLimitations")
    val `youCannotHaveTwoUnpromotedPawns` = new I18nKey("learn:youCannotHaveTwoUnpromotedPawns")
    ...
    val `makeSureAllSafe` = new I18nKey("learn:makeSureAllSafe")
    val `dontForgetYouCanDropToDefend` = new I18nKey("learn:dontForgetYouCanDropToDefend")
    ...
    val `ifYourKingIsAttacked` = new I18nKey("learn:ifYourKingIsAttacked")
    ...
    val `getOutOfCheck` = new I18nKey("learn:getOutOfCheck")
    val `watchOutForYourOpponentsReply` = new I18nKey("learn:watchOutForYourOpponentsReply")
    ...
    val `toWinInShogi` = new I18nKey("learn:toWinInShogi")
    val `dropsCommonDeliverMate` = new I18nKey("learn:dropsCommonDeliverMate")
    val `attackYourOpponentsKing` = new I18nKey("learn:attackYourOpponentsKing")
    val `chooseYourPieceCarefully` = new I18nKey("learn:chooseYourPieceCarefully")
    val `mateWithADroppedPawnIs` = new I18nKey("learn:mateWithADroppedPawnIs")
    val `mateWithAPushedPawnIs` = new I18nKey("learn:mateWithAPushedPawnIs")
    ...
    val `firstPlaceTheKing` = new I18nKey("learn:firstPlaceTheKing")
    val `dropAGold` = new I18nKey("learn:dropAGold")
    val `thenPlaceASilver` = new I18nKey("learn:thenPlaceASilver")
    val `dropTheKnights` = new I18nKey("learn:dropTheKnights")
    val `dropTheLances` = new I18nKey("learn:dropTheLances")
    val `placeTheBishopThenRook` = new I18nKey("learn:placeTheBishopThenRook")
    val `placeThePawns` = new I18nKey("learn:placeThePawns")
    val `pushingThe3rdPawn` = new I18nKey("learn:pushingThe3rdPawn")
    val `boardSetupComplete` = new I18nKey("learn:boardSetupComplete")
    val `repetition` = new I18nKey("learn:repetition")
    val `fourfoldRepetitionIsADrawExcept` = new I18nKey("learn:fourfoldRepetitionIsADrawExcept")
    val `repetitionIntro` = new I18nKey("learn:repetitionIntro")
    val `ifTheSamePositionOccurs` = new I18nKey("learn:ifTheSamePositionOccurs")
    val `perpetualCheckIsALoss` = new I18nKey("learn:perpetualCheckIsALoss")
    val `boardFlippedFindBestMove` = new I18nKey("learn:boardFlippedFindBestMove")
    val `repetitionComplete` = new I18nKey("learn:repetitionComplete")
    ...
    val `pieceValueIntroNew` = new I18nKey("learn:pieceValueIntroNew")
    val `queenOverBishop` = new I18nKey("learn:queenOverBishop")
    val `pawnsAreTheLeastValuable` = new I18nKey("learn:pawnsAreTheLeastValuable")
    val `knightSilverGold` = new I18nKey("learn:knightSilverGold")
    val `goldBishopRook` = new I18nKey("learn:goldBishopRook")
    val `takeAllThePiecesStartingFromTheMost` = new I18nKey("learn:takeAllThePiecesStartingFromTheMost")
    val `anExchangeIs` = new I18nKey("learn:anExchangeIs")
    val `theOpponentJustGaveAway` = new I18nKey("learn:theOpponentJustGaveAway")
    val `yourKingsValueIsInfinite` = new I18nKey("learn:yourKingsValueIsInfinite")
    val `twoGeneralsAreBetter` = new I18nKey("learn:twoGeneralsAreBetter")
    val `rememberWhichPieceIsTheMostValuable` = new I18nKey("learn:rememberWhichPieceIsTheMostValuable")
    val `takeThePieceWithTheHighestValue` = new I18nKey("learn:takeThePieceWithTheHighestValue")
    val `rememberTheKingIsMoreValuableThanEveryOtherPieceCombined` = new I18nKey("learn:rememberTheKingIsMoreValuableThanEveryOtherPieceCombined")
    ...
    val `youKnowHowToPlayShogi` = new I18nKey("learn:youKnowHowToPlayShogi")
    val `register` = new I18nKey("learn:register")
    val `getAFreeLishogiAccount` = new I18nKey("learn:getAFreeLishogiAccount")
    val `practice` = new I18nKey("learn:practice")
    val `learnCommonShogiPositions` = new I18nKey("learn:learnCommonShogiPositions")
    val `exerciseYourTacticalSkills` = new I18nKey("learn:exerciseYourTacticalSkills")
    val `shogiResources` = new I18nKey("learn:shogiResources")
    val `curatedShogiResources` = new I18nKey("learn:curatedShogiResources")
    val `videos` = new I18nKey("learn:videos")
    val `watchInstructiveShogiVideos` = new I18nKey("learn:watchInstructiveShogiVideos")
  ...
  object patron {
    ...
    val `lishogiPatron` = new I18nKey("patron:lishogiPatron")
    ...
    val `freeShogi` = new I18nKey("patron:freeShogi")
    ...
    val `donationSupport` = new I18nKey("patron:donationSupport")
    ...
    val `justBecamePatron` = new I18nKey("patron:justBecamePatron")
    val `downgradeNextMonth` = new I18nKey("patron:downgradeNextMonth")
    val `donationPolicy` = new I18nKey("patron:donationPolicy")
    val `expired` = new I18nKey("patron:expired")
    val `considerRenewing` = new I18nKey("patron:considerRenewing")
  ...
  object pieces {
    val `pawn` = new I18nKey("pieces:pawn")
    val `lance` = new I18nKey("pieces:lance")
    val `knight` = new I18nKey("pieces:knight")
    val `silver` = new I18nKey("pieces:silver")
    val `gold` = new I18nKey("pieces:gold")
    val `bishop` = new I18nKey("pieces:bishop")
    val `rook` = new I18nKey("pieces:rook")
    val `king` = new I18nKey("pieces:king")
    val `tokin` = new I18nKey("pieces:tokin")
    val `promotedlance` = new I18nKey("pieces:promotedlance")
    val `promotedknight` = new I18nKey("pieces:promotedknight")
    val `promotedsilver` = new I18nKey("pieces:promotedsilver")
    val `horse` = new I18nKey("pieces:horse")
    val `dragon` = new I18nKey("pieces:dragon")
    val `promotedpawn` = new I18nKey("pieces:promotedpawn")
    val `leopard` = new I18nKey("pieces:leopard")
    val `copper` = new I18nKey("pieces:copper")
    val `elephant` = new I18nKey("pieces:elephant")
    val `chariot` = new I18nKey("pieces:chariot")
    val `tiger` = new I18nKey("pieces:tiger")
    val `kirin` = new I18nKey("pieces:kirin")
    val `phoenix` = new I18nKey("pieces:phoenix")
    val `sidemover` = new I18nKey("pieces:sidemover")
    val `verticalmover` = new I18nKey("pieces:verticalmover")
    val `lion` = new I18nKey("pieces:lion")
    val `queen` = new I18nKey("pieces:queen")
    val `gobetween` = new I18nKey("pieces:gobetween")
    val `whitehorse` = new I18nKey("pieces:whitehorse")
    val `lionpromoted` = new I18nKey("pieces:lionpromoted")
    val `queenpromoted` = new I18nKey("pieces:queenpromoted")
    val `bishoppromoted` = new I18nKey("pieces:bishoppromoted")
    val `sidemoverpromoted` = new I18nKey("pieces:sidemoverpromoted")
    val `verticalmoverpromoted` = new I18nKey("pieces:verticalmoverpromoted")
    val `rookpromoted` = new I18nKey("pieces:rookpromoted")
    val `prince` = new I18nKey("pieces:prince")
    val `whale` = new I18nKey("pieces:whale")
    val `horsepromoted` = new I18nKey("pieces:horsepromoted")
    val `elephantpromoted` = new I18nKey("pieces:elephantpromoted")
    val `stag` = new I18nKey("pieces:stag")
    val `boar` = new I18nKey("pieces:boar")
    val `ox` = new I18nKey("pieces:ox")
  ...
  object preferences {
    ...
    val `handsBackground` = new I18nKey("preferences:handsBackground")
    ...
    val `boardHighlightsCheck` = new I18nKey("preferences:boardHighlightsCheck")
    val `pieceDestinations` = new I18nKey("preferences:pieceDestinations")
    val `dropDestinations` = new I18nKey("preferences:dropDestinations")
    ...
    val `colorName` = new I18nKey("preferences:colorName")
    val `displayTouchSquareOverlay` = new I18nKey("preferences:displayTouchSquareOverlay")
    ...
    val `blindfoldShogi` = new I18nKey("preferences:blindfoldShogi")
    val `shogiClock` = new I18nKey("preferences:shogiClock")
    ...
    val `traditional` = new I18nKey("preferences:traditional")
  ...
  object puzzle {
    ...
    val `findTheBestMoveForX` = new I18nKey("puzzle:findTheBestMoveForX")
    ...
    val `puzzleSource` = new I18nKey("puzzle:puzzleSource")
    ...
    val `puzzleDashboardSubtitle` = new I18nKey("puzzle:puzzleDashboardSubtitle")
    val `improvementAreas` = new I18nKey("puzzle:improvementAreas")
    val `improvementAreasSubtitle` = new I18nKey("puzzle:improvementAreasSubtitle")
    val `strengths` = new I18nKey("puzzle:strengths")
    val `strengthsSubtitle` = new I18nKey("puzzle:strengthsSubtitle")
    ...
    val `submissions` = new I18nKey("puzzle:submissions")
    val `submittedByX` = new I18nKey("puzzle:submittedByX")
  ...
  object puzzleTheme {
    ...
    val `mateIn7` = new I18nKey("puzzleTheme:mateIn7")
    val `mateIn7Description` = new I18nKey("puzzleTheme:mateIn7Description")
    val `mateIn9` = new I18nKey("puzzleTheme:mateIn9")
    val `mateIn9Description` = new I18nKey("puzzleTheme:mateIn9Description")
    ...
    val `tsume` = new I18nKey("puzzleTheme:tsume")
    val `tsumeDescription` = new I18nKey("puzzleTheme:tsumeDescription")
    val `strikingPawn` = new I18nKey("puzzleTheme:strikingPawn")
    val `strikingPawnDescription` = new I18nKey("puzzleTheme:strikingPawnDescription")
    val `joiningPawn` = new I18nKey("puzzleTheme:joiningPawn")
    val `joiningPawnDescription` = new I18nKey("puzzleTheme:joiningPawnDescription")
    val `dancingPawns` = new I18nKey("puzzleTheme:dancingPawns")
    val `dancingPawnsDescription` = new I18nKey("puzzleTheme:dancingPawnsDescription")
    val `edgeAttack` = new I18nKey("puzzleTheme:edgeAttack")
    val `edgeAttackDescription` = new I18nKey("puzzleTheme:edgeAttackDescription")
    val `veryLong` = new I18nKey("puzzleTheme:veryLong")
    val `veryLongDescription` = new I18nKey("puzzleTheme:veryLongDescription")
    val `lishogiGames` = new I18nKey("puzzleTheme:lishogiGames")
    val `lishogiGamesDescription` = new I18nKey("puzzleTheme:lishogiGamesDescription")
    val `otherSources` = new I18nKey("puzzleTheme:otherSources")
    val `otherSourcesDescription` = new I18nKey("puzzleTheme:otherSourcesDescription")
}
  ...
  object search {
    ...
    val `moves` = new I18nKey("search:moves")
  ...
  object streamer {
    ...
    val `youHaveBeenSelectedFrontpage` = new I18nKey("streamer:youHaveBeenSelectedFrontpage")
    val `noteThatOnlyLimited` = new I18nKey("streamer:noteThatOnlyLimited")
    val `soYoursMayNotAlwaysAppear` = new I18nKey("streamer:soYoursMayNotAlwaysAppear")
    ...
    val `youtubeChannelId` = new I18nKey("streamer:youtubeChannelId")
  ...
  object study {
    ...
    val `studyByX` = new I18nKey("study:studyByX")
    ...
    val `tags` = new I18nKey("study:tags")
    ...
    val `studyKif` = new I18nKey("study:studyKif")
    val `chapterKif` = new I18nKey("study:chapterKif")
    val `chapterCsa` = new I18nKey("study:chapterCsa")
    ...
    val `loadAPositionFromSfen` = new I18nKey("study:loadAPositionFromSfen")
    val `automatic` = new I18nKey("study:automatic")
    val `urlOfTheGame` = new I18nKey("study:urlOfTheGame")
    val `loadAGameFromX` = new I18nKey("study:loadAGameFromX")
    ...
    val `studyTopics` = new I18nKey("study:studyTopics")
    val `topicsDescription` = new I18nKey("study:topicsDescription")
    val `myTopics` = new I18nKey("study:myTopics")
    val `popularTopics` = new I18nKey("study:popularTopics")
    val `manageTopics` = new I18nKey("study:manageTopics")
    val `startTag` = new I18nKey("study:startTag")
    val `endTag` = new I18nKey("study:endTag")
    val `siteTag` = new I18nKey("study:siteTag")
    val `eventTag` = new I18nKey("study:eventTag")
    val `timeControlTag` = new I18nKey("study:timeControlTag")
    val `xEloTag` = new I18nKey("study:xEloTag")
    val `xTitleTag` = new I18nKey("study:xTitleTag")
    val `xTeamTag` = new I18nKey("study:xTeamTag")
    val `openingTag` = new I18nKey("study:openingTag")
    val `resultTag` = new I18nKey("study:resultTag")
    val `problemNameTag` = new I18nKey("study:problemNameTag")
    val `problemIdTag` = new I18nKey("study:problemIdTag")
    val `dateOfPublicationTag` = new I18nKey("study:dateOfPublicationTag")
    val `composerTag` = new I18nKey("study:composerTag")
    val `publicationTag` = new I18nKey("study:publicationTag")
    val `collectionTag` = new I18nKey("study:collectionTag")
    val `lengthTag` = new I18nKey("study:lengthTag")
    val `prizeTag` = new I18nKey("study:prizeTag")
    val `initHelp` = new I18nKey("study:initHelp")
    val `introGamebook` = new I18nKey("study:introGamebook")
    val `putFirstMove` = new I18nKey("study:putFirstMove")
    val `explainMove` = new I18nKey("study:explainMove")
    val `reflectOnMove` = new I18nKey("study:reflectOnMove")
    val `variationMoves` = new I18nKey("study:variationMoves")
    val `explainWrongMove` = new I18nKey("study:explainWrongMove")
    val `orPromote` = new I18nKey("study:orPromote")
    val `otherMove` = new I18nKey("study:otherMove")
    val `explainAllWrong` = new I18nKey("study:explainAllWrong")
    val `hintOnDemand` = new I18nKey("study:hintOnDemand")
    val `playerTip` = new I18nKey("study:playerTip")
    val `playQuestion` = new I18nKey("study:playQuestion")
  ...
  object team {
    ...
    val `teamPage` = new I18nKey("team:teamPage")
  ...
  object tourArrangements {
    val `roundRobin` = new I18nKey("tourArrangements:roundRobin")
    val `startGameNow` = new I18nKey("tourArrangements:startGameNow")
    val `goToGame` = new I18nKey("tourArrangements:goToGame")
    val `gameScheduling` = new I18nKey("tourArrangements:gameScheduling")
    val `suggestTime` = new I18nKey("tourArrangements:suggestTime")
    val `suggestDifferentTime` = new I18nKey("tourArrangements:suggestDifferentTime")
    val `acceptSuggestedTime` = new I18nKey("tourArrangements:acceptSuggestedTime")
    val `xAcceptedTime` = new I18nKey("tourArrangements:xAcceptedTime")
    val `suggestedTime` = new I18nKey("tourArrangements:suggestedTime")
    val `scheduledAt` = new I18nKey("tourArrangements:scheduledAt")
    val `startedAt` = new I18nKey("tourArrangements:startedAt")
    val `upcomingGameWithX` = new I18nKey("tourArrangements:upcomingGameWithX")
    val `yourUpcomingGames` = new I18nKey("tourArrangements:yourUpcomingGames")
    val `allUpcomingAndOngoingGames` = new I18nKey("tourArrangements:allUpcomingAndOngoingGames")
    val `myArrangedGames` = new I18nKey("tourArrangements:myArrangedGames")
    val `gameWillNotStart` = new I18nKey("tourArrangements:gameWillNotStart")
    val `organized` = new I18nKey("tourArrangements:organized")
    val `existingGamesBetweenPlayers` = new I18nKey("tourArrangements:existingGamesBetweenPlayers")
    val `pointsWDL` = new I18nKey("tourArrangements:pointsWDL")
    val `gameName` = new I18nKey("tourArrangements:gameName")
    val `howDoesRoundRobinWork` = new I18nKey("tourArrangements:howDoesRoundRobinWork")
    val `howDoesRoundRobinWorkAnswerNew` = new I18nKey("tourArrangements:howDoesRoundRobinWorkAnswerNew")
    val `howToPlayGames` = new I18nKey("tourArrangements:howToPlayGames")
    val `howToPlayGamesAnswerNew` = new I18nKey("tourArrangements:howToPlayGamesAnswerNew")
    val `roundRobinScoring` = new I18nKey("tourArrangements:roundRobinScoring")
    val `roundRobinScoringAnswer` = new I18nKey("tourArrangements:roundRobinScoringAnswer")
    val `roundRobinWinner` = new I18nKey("tourArrangements:roundRobinWinner")
    val `roundRobinWinnerAnswer` = new I18nKey("tourArrangements:roundRobinWinnerAnswer")
    val `howDoOrganizedTournamentsWork` = new I18nKey("tourArrangements:howDoOrganizedTournamentsWork")
    val `howDoOrganizedTournamentsWorkAnswerNew` = new I18nKey("tourArrangements:howDoOrganizedTournamentsWorkAnswerNew")
    val `whoStartsMatches` = new I18nKey("tourArrangements:whoStartsMatches")
    val `whoStartsMatchesAnswerNew` = new I18nKey("tourArrangements:whoStartsMatchesAnswerNew")
    ...
    val `annulResults` = new I18nKey("tourArrangements:annulResults")
    val `annulledGames` = new I18nKey("tourArrangements:annulledGames")
}
  ...
  object tourname {
    ...
    val `weekendX` = new I18nKey("tourname:weekendX")
    val `eliteX` = new I18nKey("tourname:eliteX")
    val `xArena` = new I18nKey("tourname:xArena")
    val `xRobin` = new I18nKey("tourname:xRobin")
}
