...
val `asWhite` = new I18nKey("asWhite")
val `asBlack` = new I18nKey("asBlack")
...
val `blackDeclinesImpasse` = new I18nKey("blackDeclinesImpasse")
val `blackOffersImpasse` = new I18nKey("blackOffersImpasse")
val `notationType` = new I18nKey("notationType")
val `whiteDeclinesImpasse` = new I18nKey("whiteDeclinesImpasse")
val `whiteOffersImpasse` = new I18nKey("whiteOffersImpasse")
...
val `aCoordinateAppears` = new I18nKey("coordinates:aCoordinateAppears")
val `aSquareIsHighlightedExplanation` = new I18nKey("coordinates:aSquareIsHighlightedExplanation")
val `youHaveThirtySeconds` = new I18nKey("coordinates:youHaveThirtySeconds")
val `goAsLongAsYouWant` = new I18nKey("coordinates:goAsLongAsYouWant")
...
val `back` = new I18nKey("study:back")
...
val `lishogiSupportChessAnd` = new I18nKey("faq:lishogiSupportChessAnd")
