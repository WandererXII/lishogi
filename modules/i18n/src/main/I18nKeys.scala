...
object I18nKeys {
  ...
  val `officialBlog` = new I18nKey("officialBlog")
  val `blogPostsFromYear` = new I18nKey("blogPostsFromYear")
  val `previousBlogPosts` = new I18nKey("previousBlogPosts")
  val `continueReadingThis` = new I18nKey("continueReadingThis")
  val `discussBlogForum` = new I18nKey("discussBlogForum")
  ...
  object coach {
    ...
    val `allLanguages` = new I18nKey("coach:allLanguages")
    ...
    val `basicsTab` = new I18nKey("coach:basicsTab")
    val `textsTab` = new I18nKey("coach:textsTab")
    val `contentsTab` = new I18nKey("coach:contentsTab")
    val `profileSaved` = new I18nKey("coach:profileSaved")
}
