  ...
  implicit val prefBSONHandler: BSON[Pref] = new BSON[Pref] {
    ...
    def reads(r: BSON.Reader): Pref =
      Pref(
        ...
        dobutsuPieceSet = r.getD("dobutsuPieceSet", Pref.default.dobutsuPieceSet),
        ...
        noFlags = r.getD("noFlags", Pref.default.noFlags),
        noRanks = r.getD("noRanks", Pref.default.noRanks),
    ...
    def writes(w: BSON.Writer, o: Pref) =
      $doc(
        ...
        "dobutsuPieceSet"    -> o.dobutsuPieceSet,
        "soundSet"           -> o.soundSet,
