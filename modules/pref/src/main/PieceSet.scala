...
object PieceSet extends PieceSetBase {
  ...
  val all = List(
    ...
    new PieceSet("dewitt_1kanji", "DeWitt 1-kanji", pro = true),
    new PieceSet("dewitt_2kanji", "DeWitt 2-kanji", pro = true),
    new PieceSet("dewitt_czech", "DeWitt Czech", pro = true),
