...
final class FairyConversionTest extends Specification {
  ...
  "dobutsu" in {
    ...
    "drops" in {
      Dobutsu.fairyToUsi("C*1a") must_== "P*1a"
      Dobutsu.usiToFairy("P*1a") must_== "C*1a"
      Dobutsu.fairyToUsi("E*1a") must_== "B*1a"
      Dobutsu.usiToFairy("B*1a") must_== "E*1a"
      Dobutsu.fairyToUsi("G*1a") must_== "R*1a"
      Dobutsu.usiToFairy("R*1a") must_== "G*1a"
    }

    "moves" in {
      Dobutsu.fairyToUsi("1b2b") must_== "1b2b"
      Dobutsu.usiToFairy("1b2b") must_== "1b2b"
      Dobutsu.fairyToUsi("1b1a+") must_== "1b1a+"
      Dobutsu.usiToFairy("1b1a+") must_== "1b1a+"
    }
  }
