...
object StreamerForm {
  ...
  private def descriptionField =
    of[Description].verifying(constraint.maxLength[Description](_.value)(50000))
  implicit private val nameFormat: Formatter[Name] =
    formatter.stringFormatter[Name](_.value, Name.apply)
