...
private object BSONHandlers {
  ...
  implicit val NotifiesHandler: BSONHandler[Notifies] =
    stringAnyValHandler[Notifies](_.value, Notifies.apply)
  ...
  implicit val TopicIdHandler: BSONHandler[TopicId] =
    stringAnyValHandler[TopicId](_.value, TopicId.apply)
  implicit val CategoryHandler: BSONHandler[Category] =
    stringAnyValHandler[Category](_.value, Category.apply)
  implicit val PostIdHandler: BSONHandler[PostId] =
    stringAnyValHandler[PostId](_.value, PostId.apply)
  ...
  implicit val StudyIdHandler: BSONHandler[StudyId] =
    stringAnyValHandler[StudyId](_.value, StudyId.apply)
  ...
  implicit val PMSenderIdHandler: BSONHandler[Sender] =
    stringAnyValHandler[Sender](_.value, Sender.apply)
  implicit val PMTextHandler: BSONHandler[Text] = stringAnyValHandler[Text](_.value, Text.apply)
  implicit val PrivateMessageHandler: BSONDocumentHandler[PrivateMessage] =
    Macros.handler[PrivateMessage]
  ...
  implicit val ArrangementReminderHandler: BSONDocumentHandler[ArrangementReminder] =
    Macros.handler[ArrangementReminder]
  implicit val ArrangementConfirmationHandler: BSONDocumentHandler[ArrangementConfirmation] =
    Macros.handler[ArrangementConfirmation]
  ...
  implicit val NotificationContentHandler: BSON[NotificationContent] =
    new BSON[NotificationContent] {
      ...
      private def writeNotificationContent(notificationContent: NotificationContent) = {
        notificationContent match {
          ...
          case x: ArrangementReminder        => ArrangementReminderHandler.writeTry(x).get
          case x: ArrangementConfirmation    => ArrangementConfirmationHandler.writeTry(x).get
      ...
      def reads(reader: Reader): NotificationContent =
        reader.str("type") match {
          ...
          case "arrangementReminder" => ArrangementReminderHandler.readTry(reader.doc).get
          case "arrangementConfirmation" => ArrangementConfirmationHandler.readTry(reader.doc).get
  ...
  implicit val NotificationBSONHandler: BSONDocumentHandler[Notification] =
