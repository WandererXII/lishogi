...
class HashTest extends ShogiTest {
  ...
  "Hasher" should {
    ...
    "hash hands" in {
      val gotePawn     = ((format.Forsyth << "lnsgkgsnl/1r5b1/pppppp1pp/6p2/9/2P6/PP1PPPPPP/1B5R1/LNSGKGSNL b p 3") get) withVariant Standard
      val gotePawnHash = hash(gotePawn)

      val sentePawn     = (format.Forsyth << "lnsgkgsnl/1r5b1/pppppp1pp/6p2/9/2P6/PP1PPPPPP/1B5R1/LNSGKGSNL b P 3") get
    ...
    "many rooks in hands" in {
      val goteRooks     = ((format.Forsyth << "lnsgkgsnl/1r5b1/pppppp1pp/6p2/9/2P6/PP1PPPPPP/1B5R1/LNSGKGSNL b 18r 3") get) withVariant Standard
      val goteRooksHash = hash(goteRooks)

      val senteRooks     = (format.Forsyth << "lnsgkgsnl/1r5b1/pppppp1pp/6p2/9/2P6/PP1PPPPPP/1B5R1/LNSGKGSNL b 18R 3") get
    ...
    "18+ pieces wraps back (%19)" in {
      val goteRooks     = ((format.Forsyth << "lnsgkgsnl/1r5b1/pppppp1pp/6p2/9/2P6/PP1PPPPPP/1B5R1/LNSGKGSNL b - 3") get) withVariant Standard
      val goteRooksHash = hash(goteRooks)

      val senteRooks     = (format.Forsyth << "lnsgkgsnl/1r5b1/pppppp1pp/6p2/9/2P6/PP1PPPPPP/1B5R1/LNSGKGSNL b 19R 3") get
      val senteRoksHash = hash(senteRooks)
