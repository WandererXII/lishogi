...
object perfStat {
  ...
  private def playStreakNbStreak(s: lila.perfStat.Streak, title: Frag => Frag)(implicit
      lang: Lang,
  ): Frag =
    div(
      div(cls := "streak")(
  ...
  private def playStreakTimeStreak(s: lila.perfStat.Streak, title: Frag => Frag)(implicit
      lang: Lang,
  ): Frag =
    div(
      div(cls := "streak")(
