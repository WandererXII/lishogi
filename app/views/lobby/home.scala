    ...
    views.html.base.layout(
      ...
      main(
        ...
        div(cls := "lobby__about")(
          ...
          a(href := routes.Article.tos)(trans.termsOfService()),
          a(href := routes.Article.privacy)(trans.privacy()),
          a(href := routes.Article.friendlySites)(trans.contact.friendlySites()),
